...
> **候选声明**：本文件为 `PLAN-WSC-2.1` Round 1 异议吸收稿（`lineageFrom: PLAN-WSC-2.1`）。`round: 1` 表示**本 planId（PLAN-WSC-2.2）** 的共识轮次，待 Round 2 独立评审。未全员 APPROVE 前不得派发任务。本计划正文自足，评审者无需打开 PLAN-WSC-2.0 / 2.1 即可复核 DAG 与写集。
