...
public final class ImportFieldMapper {

  private final CatalogBrowseSeedStore catalog;
  private final AtomicInteger codeSeq = new AtomicInteger(1);

  public ImportFieldMapper(CatalogBrowseSeedStore catalog) {
    this.catalog = catalog;
  }

  public Map<String, Object> toWriteBody(Map<String, String> cells) throws RowException {
  ...
  public static final class RowException extends Exception {
    public final String code;
    public final String message;

    public RowException(String code, String message) {
      super(message);
      this.code = code;
