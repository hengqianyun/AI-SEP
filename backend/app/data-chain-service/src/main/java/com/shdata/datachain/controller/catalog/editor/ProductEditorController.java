...
/** 产品写 API — POST/PUT/DELETE /catalog/products（鉴权由 WriteAuthorizationInterceptor）。 */
@RestController
...
public class ProductEditorController {
  ...
  public ResponseEntity<Map<String, Object>> delete(
    ...
    String correlationId = CorrelationIdSupport.resolve(request);
    return service.delete(productId, actorId(request), correlationId).toResponseEntity(correlationId);
  }
