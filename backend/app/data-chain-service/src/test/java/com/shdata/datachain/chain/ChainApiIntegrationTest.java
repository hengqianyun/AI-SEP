...
class ChainApiIntegrationTest {
  ...
  void getSnapshot_byVersionId() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(jsonPath("$.data.categoryPathParts.l1").value("金融服务"))
        .andExpect(jsonPath("$.data.categoryPathParts.l2").value("征信评估"))
        .andExpect(jsonPath("$.data.categoryPathParts.l3").value("征信评分"))
